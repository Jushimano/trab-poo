...
function Addimovel({ eventoTeclado, obj}) { //problema: Tem duas paginas de cadastro, quando muda de pagina, perde os valores nessas variaveis? Ou se mantem e depois coloca tudo de uma vez?
        ...
        <div className="container">
            ...
            <form>
                <label className="texto_1">
                    ...
                    <input type="text" value={obj.nome} onChange={eventoTeclado} name='nome' className="box_texto1" /><br></br>
                </label>
                <label className="texto_2">
                    Área privada (m²)<br></br>
                    <input type="text" value={obj.area} onChange={eventoTeclado} name='area' className="box_texto2" /><br></br>
                </label>
                <label className="texto_3">
                    N° de quartos:<br></br>
                    <select className="box_texto3" value={obj.num_quarto} onChange={eventoTeclado} name='num_quarto'>
                ...
                <label className="texto_4">
                    ...
                    <select className="box_texto4" value={obj.num_vagas} onChange={eventoTeclado} name='num_vagas'>
                        {[...Array(11).keys()].map(num => (
                            <option key={num} value={num}>{num}</option>
                        ))}
                    </select><br></br>
                ...
                <label className="texto_5">
                    ...
                    <select className="box_texto5" value={obj.tipo} onChange={eventoTeclado} name='tipo'>
                ...
                <label className="texto_6">
                    ...
                    <input type="file" accept="image/*" value={obj.imagem} onChange={eventoTeclado} name='imagem' className="box_texto6" /><br></br>
                </label>
            </form>
